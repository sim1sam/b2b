        ...
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('customer.purchase-requests.update', $purchaseRequest) }}" method="POST" id="editPurchaseRequestForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('customer.purchase-requests.index') }}" class="btn btn-secondary">
