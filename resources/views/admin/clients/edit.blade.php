        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit: {{ $client->business_name ?? $client->name }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.clients.update', $client->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @if($client->logo)
                                <div class="mb-2">
                                    <p>Current Logo:</p>
                                    <img src="{{ Storage::url($client->logo) }}" alt="Current Logo" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile_number" id="mobile_number" 
                                   ...
                                   value="{{ old('mobile_number', $client->mobile_number) }}" placeholder="e.g., +880 1234567890">
                            @error('mobile_number')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="exchange_rate" id="exchange_rate" 
                                       ...
                                       value="{{ old('exchange_rate', $client->exchange_rate ?? 1.0) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="lowest_shipping_charge_per_kg" id="lowest_shipping_charge_per_kg" 
                                       ...
                                       value="{{ old('lowest_shipping_charge_per_kg', $client->lowest_shipping_charge_per_kg ?? 0) }}" 
