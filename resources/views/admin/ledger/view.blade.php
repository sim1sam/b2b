...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.ledger.index', ['customer_id' => $customer->id, 'start_date' => $startDate, 'end_date' => $endDate]) }}" class="btn btn-sm btn-secondary">
                ...
                <div class="col-md-6 text-right" style="display: flex; flex-direction: column; justify-content: space-between;">
                    ...
                    <div style="display: flex; justify-content: flex-end; align-items: flex-start; margin-bottom: 10px;">
                        ...
                        <div style="margin-left: 15px;">
                            <div class="btn-group">
                                <a href="{{ route('admin.ledger.download', ['customer' => $customer->id, 'start_date' => $startDate, 'end_date' => $endDate]) }}" class="btn btn-sm btn-success">
                    ...
                    <div style="margin-top: 10px;">
                        <p class="mb-1"><strong>Client:</strong> {{ $customer->business_name ?? $customer->name }}</p>
