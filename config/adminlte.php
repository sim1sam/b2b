...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Purchase Requests',
            'url' => 'customer/purchase-requests',
            'icon' => 'fas fa-fw fa-shopping-cart',
            'role' => 'customer',
        ],
        [
    ...
    */
    ...
    'filters' => [
        ...
        App\Menu\RoleMenuFilter::class, // Run before HrefFilter to resolve dynamic URLs
